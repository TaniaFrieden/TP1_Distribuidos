...
class ProcesadorRegistros:
    ...
    def procesar_batch_transacciones(self, client_id: str, schema: list, records: list, estado_agregador: dict):
    ...
    def procesar_batch_bancos(self, client_id: str, schema: list, records: list, estado_agregador: dict):
        ...
        for record_values in records:
            ...
            if bank_name_idx is not None:
                estado_agregador[client_id][bank_id]["bank_name"] = record_values[bank_name_idx]
    ...
    def procesar_registro_individual(self, queue_name: str, client_id: str, payload: dict, estado_agregador: dict):
        ...
        if "banks" in queue_name:
            estado_agregador[client_id][bank_id]["bank_name"] = payload.get("Bank Name", "Desconocido")
            if estado_agregador[client_id][bank_id]["account"] == "Desconocida":
                estado_agregador[client_id][bank_id]["account"] = payload.get("Account Number", "Desconocida")
